...
import { CutCommand, DeleteCommand, MirrorCommand, MoveCommand, RadialArrayCommand, RotateCommand, ScaleCommand, ShellCommand } from "../src/commands/GeometryCommands";
...
test('when a solid is selected you get move/rotate/scale', () => {
    ...
    expect(toolbar.commands).toEqual([
        DeleteCommand, RotateCommand, ShellCommand, MoveCommand, ScaleCommand, MirrorCommand, RadialArrayCommand, CutCommand
    ])
})