...
import { RotateItemFactory } from '../../src/commands/translate/TranslateItemFactory';
...
beforeEach(() => {
    ...
    rotate = new RotateItemFactory(db, materials, signals);
})
