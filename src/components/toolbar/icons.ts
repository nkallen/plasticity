...
keybindings.set("gizmo:loft:thickness", "Thickness");
...
keybindings.set("gizmo:box:width", "Width");
keybindings.set("gizmo:box:length", "Length");
keybindings.set("gizmo:box:height", "Height");
