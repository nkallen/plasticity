...
keybindings.set("rotate:rotate:free", "Freestyle");
keybindings.set("rotate:rotate:pivot", "Pivot");
...
keybindings.set("gizmo:edit-cylinder:radius", "Radius");
keybindings.set("gizmo:edit-cylinder:height", "Height");
