...
icons.set(ModifyFaceCommand.OffsetFaceCommand, offsetFace);
...
icons.set(ExtrudeCommand.ExtrudeCommand, extrude);
...
tooltips.set(ModifyFaceCommand.OffsetFaceCommand, "Offset face");
...
tooltips.set(ExtrudeCommand.ExtrudeCommand, "Extrude");
