...
import { IdMaterial, LineSegmentGeometryAddon, LineVertexColorMaterial, vertexColorLineMaterial, VertexColorMaterial, vertexColorMaterial } from "../components/viewport/gpu_picking/GPUPickingMaterial";
