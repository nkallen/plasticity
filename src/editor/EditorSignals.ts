...
export class EditorSignals {
    ...
    objectHidden: signals.Signal<[NodeItem, HideMode]> = new signals.Signal();
    objectUnhidden: signals.Signal<[NodeItem, HideMode]> = new signals.Signal();
    objectSelectable: signals.Signal<[NodeItem, HideMode]> = new signals.Signal();
    objectUnselectable: signals.Signal<[NodeItem, HideMode]> = new signals.Signal();
