            ...
            <>
                ...
                <ul>
                    ...
                    <li class={type === c3d.ConnectingType.Bridge ? 'disabled' : ''}>
                        ...
                        <input type="radio" name="mating1" id="mating1_tangent" value={c3d.MatingType.Tangent} checked={mating1 === c3d.MatingType.Tangent} onClick={this.onChange}></input>
                        <label class="btn" for="mating1_tangent">Tangent</label>

                        <input type="radio" name="mating1" id="mating1_smoothg2" value={c3d.MatingType.SmoothG2} checked={mating1 === c3d.MatingType.SmoothG2} onClick={this.onChange}></input>
                        <label class="btn" for="mating1_smoothg2">G2</label>

                        <input type="radio" name="mating1" id="mating1_smoothg3" value={c3d.MatingType.SmoothG3} checked={mating1 === c3d.MatingType.SmoothG3} onClick={this.onChange}></input>
                        <label class="btn" for="mating1_smoothg3">G3</label>
                    </li>
                    <li class={type === c3d.ConnectingType.Bridge ? 'disabled' : ''}>
                        <label for="mating2">Mating 2</label>
                        <input type="radio" name="mating2" id="mating2_tangent" value={c3d.MatingType.Tangent} checked={mating2 === c3d.MatingType.Tangent} onClick={this.onChange}></input>
                        <label class="btn" for="mating2_tangent">Tangent</label>

                        <input type="radio" name="mating2" id="mating2_smoothg2" value={c3d.MatingType.SmoothG2} checked={mating2 === c3d.MatingType.SmoothG2} onClick={this.onChange}></input>
                        <label class="btn" for="mating2_smoothg2">G2</label>

                        <input type="radio" name="mating2" id="mating2_smoothg3" value={c3d.MatingType.SmoothG3} checked={mating2 === c3d.MatingType.SmoothG3} onClick={this.onChange}></input>
